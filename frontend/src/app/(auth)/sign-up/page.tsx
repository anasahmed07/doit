...
import { UserPlus, Loader2, Zap, Eye, EyeOff } from "lucide-react";
...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    await authClient.signUp.email(
      ...
      {
        onSuccess: () => {
          // You might want to show a "verify email" message
          // or automatically sign them in. For simplicity, we'll redirect.
